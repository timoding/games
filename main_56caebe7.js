...
var policy_main_CustomStyle = styled_components_browser_esm/* default.div */.ZP.div(policy_main_templateObject || (policy_main_templateObject = policy_main_taggedTemplateLiteralLoose(["\n\twidth: 1100px;\n\tmargin: auto;\n\tpadding-top: 200px;\n\tfont-family: \"Poppins-Medium\";\n\tmargin-bottom: 200px;\n\n\t.news_meta {\n\t\tfont-size: 12px;\n\t\tmargin-bottom: 30px;\n\t\ta {\n\t\t\tcolor: #fff;\n\t\t\tfont-size: 12px;\n\t\t\t&:hover {\n\t\t\t\tcolor: #f8b31a;\n\t\t\t}\n\t\t}\n\t\timg {\n\t\t\theight: 10px;\n\t\t\tmargin: 0 10px;\n\t\t}\n\t}\n\th2 {\n\t\tfont-size: 14px;\n\t\tmargin-bottom: 15px;\n\t}\n\t.news_conter {\n\t\timg {\n\t\t\twidth: 100%;\n\t\t\tmargin-bottom: 30px;\n\t\t}\n\t\tp {\n\t\t\tfont-size: 20px;\n\t\t\tfont-family: \"Poppins-Bold\";\n\t\t\tmargin-top: 30px;\n\t\t}\n\t\tspan {\n\t\t\tdisplay: block;\n\t\t\tfont-size: 14px;\n\t\t\tmargin-bottom: 20px;\n\t\t\topacity: .85;\n\t\t}\n\t}\n\n\n\t@media (max-width: 750px) {\n\t\twidth: 92%;\n\t\tpadding-top: 100px;\n\t\tmargin-bottom: 50px;\n\t}\n"])));
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [863], () => (__webpack_require__(97753)))
